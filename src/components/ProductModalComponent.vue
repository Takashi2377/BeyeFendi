              ...
              <div class="row mb-3">
                <div class="col-sm-4">
                  <div class="form-group mb-3">
                    ...
                    <input id="imageUrl" v-model="editProduct.imageUrl" type="text" class="form-control" placeholder="請輸入圖片連結">
                  ...
                  <div v-if="Array.isArray(editProduct.imagesUrl)">
                    <div class="mb-1" v-for="(image, key) in editProduct.imagesUrl" :key="key">
                      <div class="form-group">
                        ...
                        <input :id="`imagesUrl${key}`" v-model="editProduct.imagesUrl[key]" type="text" class="form-control"
                          placeholder="請輸入圖片連結">
                      </div>
