<template>
    <div>
      ...
      <CouponModalComponent :coupon="tempCoupon" :is-new="isNew" ref="couponModal" @update-coupon="updateCoupon" />
      <DelProductModalComponent :item="tempCoupon" ref="delModal" @del-item="delCoupon" />
    </div>
  </template>
...
export default {
  components: { CouponModalComponent, DelProductModalComponent },
  props: {
    config: Object
  },
  data () {
